...
const login = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = yield (0, isUserExists_1.isUserExist)(phoneNumber, user_model_1.User);
    if (!user) {
...
const refreshToken = (token) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let isUserExists = yield user_model_1.User.findById({ _id: userId }, { _id: 1, role: 1 }).lean();
    if (!isUserExists) {
        // Check if the user exists in the User collection
        isUserExists = yield admin_model_1.Admin.findById({ _id: userId }, { _id: 1, role: 1 }).lean();
    }
    if (!isUserExists) {
